...
This file is the quick-reference operating contract for async-io-kotlin. The longer
...
async-io-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`async-io`](https://crates.io/crates/async-io). Upstream Rust is the behavioral oracle while the
