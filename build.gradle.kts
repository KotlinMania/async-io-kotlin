...
kotlin {
    ...
    swiftExport {
        moduleName = "AsyncIo"
        flattenPackage = "io.github.kotlinmania.asyncio"
    }

    android {
        namespace = "io.github.kotlinmania.asyncio"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "async-io-kotlin", version.toString())

    pom {
        name.set("async-io-kotlin")
        description.set("Kotlin Multiplatform port of smol-rs/async-io - Async I/O and timers")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/async-io-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/async-io-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/async-io-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/async-io-kotlin.git")
        }
    }
}
...
val codeqlCompileJvm = tasks.register<JavaExec>("codeqlCompileJvm") {
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve("io/github/kotlinmania/asyncio/CodeqlEmptySentinel.kt")
...
val fullTargetBuildTasks = listOf(
    ...
    "embedSwiftExportForXcode",
    "assembleAsyncIoXCFramework",
    "assembleAsyncIoDebugXCFramework",
    "assembleAsyncIoReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseIosFatFrameworkForAsyncIoXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAsyncIoXCFramework",
    "assembleDebugMacosFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseMacosFatFrameworkForAsyncIoXCFramework",
    "assembleDebugTvosFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseTvosFatFrameworkForAsyncIoXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAsyncIoXCFramework",
    "assembleDebugWatchosFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseWatchosFatFrameworkForAsyncIoXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAsyncIoXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAsyncIoXCFramework",
